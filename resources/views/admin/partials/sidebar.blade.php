<div class="sidebar">
    <div class="sidebar-header">
        <div>
            <a href="{{route('home')}}" class="sidebar-logo"><span>E-notes</span></a>
...
{{--                    <a href="{{route('contact.create')}}" class="nav-sub-link">New Contact</a>--}}
            ...
            <li class="nav-item">
                <a href="" class="nav-link with-sub"><i data-feather="user"></i> Program Category</a>
                <nav class="nav nav-sub">
                    <a href="{{route('category.index')}}" class="nav-sub-link">Category</a>
                    <a href="{{route('program.create')}}" class="nav-sub-link">New Program</a>
                    <a href="{{route('program.index')}}" class="nav-sub-link">All Programs</a>
                </nav>
            </li>
{{--            <li class="nav-item">--}}
...
{{--            </li>--}}
            <!-- <li class="nav-item">
                ...
                <nav class="nav nav-sub">
                    <a href=" " class="nav-sub-link">New services</a>
                    <a href="" class="nav-sub-link">All Services</a>
