        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Create</strong> program</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('program.update',[$program ->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-description">Program</label>
                        <div class="col-md-9">
                            ...
                            <select class="form-control form-control-sm select2" id="category_id" name="category_id">
                                ...
                                @forelse($category as $category)
                                    <option value="{{$category->id}}" {{ (isset($program) && $program->category_id==$category->id) ? 'selected': "" }}>{{$category->title}}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($program ) ? $program ->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="semester" name="semester" class="form-control {{ $errors->has('semester') ? 'has-error' : '' }}"  value="{{ old('title', isset($program ) ? $program ->semester : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="subject" name="subject" class="form-control {{ $errors->has('subject') ? 'has-error' : '' }}"  value="{{ old('title', isset($program ) ? $program ->subject : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="date" id="date" name="date" class="form-control {{ $errors->has('date') ? 'has-error' : '' }}"  value="{{  old('date', isset($program ) ? $program ->date : '')  }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="file" name="file" class="form-control {{ $errors->has('file') ? 'has-error' : '' }}"  value="{{ old('file', isset($file) ? $program ?? ''->file : '') }}">
