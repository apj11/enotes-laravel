                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><i class="fa fa-pencil"></i> <strong>Create</strong> event</h2>
                            </div>
                            <!-- END General Data Title -->

                            <!-- General Data Content -->
                            <form action="{{route('event.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-name">Venue</label>
                                    <div class="col-md-9">
                                        <input type="text" id="venue" name="venue" class="form-control {{ $errors->has('venue') ? 'has-error' : '' }}" placeholder="Enter Venue..">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-name">Time</label>
                                    <div class="col-md-9">
                                        <input type="text" id="time" name="time" class="form-control {{ $errors->has('time') ? 'has-error' : '' }}" placeholder="Enter time..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" id="date" name="date" class="form-control {{ $errors->has('date') ? 'has-error' : '' }}" placeholder="Enter date ">
...
{{--                                    <div class="col-md-9">--}}
{{--                                        <input type="text" id="author" name="author" class="form-control {{ $errors->has('author') ? 'has-error' : '' }}" placeholder="Enter title..">--}}
...
{{--                                    <div class="col-md-9">--}}
{{--                                        <input type="text" id="category" name="category" class="form-control {{ $errors->has('category') ? 'has-error' : '' }}" placeholder="Enter ..">--}}
...
{{--                                <div class="form-group">--}}
{{--                                    <label class="col-md-3 control-label" for="product-description">Team Name and  Description</label>--}}
{{--                                    <div class="col-md-9">--}}
{{--                                        <!-- CKEditor, you just need to include the plugin (see at the bottom of this page) and add the class 'ckeditor' to your textarea -->--}}
{{--                                        <!-- More info can be found at http://ckeditor.com -->--}}
{{--                                        <textarea id="team_description" name="team_description" class="ckeditor  {{ $errors->has('team_description') ? 'has-error' : '' }}"></textarea>--}}
