        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Create</strong> Category</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('category.update',[$category->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($category) ? $category->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="image" name="image" class="form-control {{ $errors->has('image') ? 'has-error' : '' }}"  value="{{ old('image', isset($category) ? $category->image : '') }}">
...
{{--                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" > {!! old('description', isset($about) ? $about->description : '') !!}  </textarea>--}}
...
{{--                    <div class="form-group">--}}
{{--                        <label class="col-md-3 control-label" for="product-name">History</label>--}}
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="history" name="history" class="form-control {{ $errors->has('history') ? 'has-error' : '' }}"  value="{{ old('history', isset($about) ? $about->history : '') }}">--}}
