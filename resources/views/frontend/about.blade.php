...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <p>This website caters to all the needs of students. Even if you’re not , you can easily access all the libraries , and it isn’t as if the books are exclusive to one school,college or university. It has links to various other public domain e-libraries , categorised accordingly, from where you can easily access all the e-resources.
          </p>
          <div class="col-xs-10">
          ...
          <div class="col-xs-10">
            <p>Searching for the right study material is a hard task.  The next time you need some help to find notes and study material, access these free websites and find something substantial, rather than copying off the whole wiki page. So remember to bookmark this note and use it for further reference.</p>
          </div>
        </div>
          <pre>
        <div class="col-md-6">
