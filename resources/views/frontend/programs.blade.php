                ...
                <div class="row">
                    @foreach($category as $category)
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <div class="single-gallery-img contact-program ">
                                <div class="course-img">
                                    <a href="{{route('programfile.show', $category->id)}}"> <img src="{{asset(''.$category->image)}}" height="250px" width="250px" alt="course">
                                ...
                                <div class="course-content">
                                    ...
                                    <a class="btn btn-danger" href="{{route('programfile.show', $category->id)}}">Get Notes</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
